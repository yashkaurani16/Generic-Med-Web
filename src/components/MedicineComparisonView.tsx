        ...
        <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full h-11 pl-10 pr-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-xs sm:text-sm text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 shadow-xs transition"
            />
            {searchQuery && (
              <button
      ...
      <div className="space-y-6">
        {filteredMedicines.length === 0 ? (
          ...
          filteredMedicines.map((med) => {
            ...
            const offersForPack = getOffersForMedicinePack(med.id, currentPack.packId);
            const lowestOffer = getLowestComparableOffer(med.id, currentPack.packId);
