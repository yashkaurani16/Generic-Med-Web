...
import { BulkPriceUpload } from './BulkPriceUpload';
...
export const PharmacyPortalView: React.FC = () => {
  ...
  const [activeSubTab, setActiveSubTab] = useState<'orders' | 'rx_review' | 'inventory' | 'bulk_upload' | 'metrics'>('orders');
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Subtab 4: Bulk Price & Stock Upload */}
      {activeSubTab === 'bulk_upload' && <BulkPriceUpload />}
